...
def janela2():
    ...
    def janela_valores():
        ...
        def botao_adicionar():
            ...
            def botao_adicionar_servico():
                ...
                INSERT INTO Serviços(Código, Nome,  Preço) VALUES(?, ?, ?)
                """,(Codigo, Nome, Preco))
            ...
            #botoes
            bt_voltar = Button(master_valores2,bd=0,image=img_botao_voltar_valores2,command= lambda:[master_valores2.destroy(),janela_valores()])
            bt_voltar.place(width=192,height=100,x=407,y=857)
            bt_adicionar = Button(master_valores2,bd=0,image=img_botao_adicionar,command= botao_adicionar_servico)
            bt_adicionar.place(width=258,height=100,x=55,y=857)
            bt_atualizar_valores = Button(master_valores2,bd=0,image=img_botao_atualizar)
        ...
        # botoes
        bt_voltar = Button(master_valores,bd=0,image=img_botao_voltar,command= lambda:[voltar_janela2()])
        bt_voltar.place(width=192,height=100,x=130,y=832)
        bt_adicionar = Button(master_valores,bd=0,image=img_botao_adicionar,command= lambda:[botao_adicionar()])
    ...
    def janela_cadastro():
        ...
        #botoes
        bt_voltar = Button(master_cadastro,bd=0,image=img_botao_voltar,command= lambda:[voltar_janela2()])
        bt_voltar.place(width=192,height=100,x=310,y=832)
        bt_ok = Button(master_cadastro,bd=0,image=img_botao_ok,command= lambda:[botao_ok()])
    ...
    bt_verificar = Button(master2,bd=0,image=img_botao_verificar)
    bt_verificar.place(width= 253, height=100,x=63,y=376)
    bt_editar = Button(master2,bd=0,image=img_botao_editar)
    bt_editar.place(width= 253, height=100,x=63,y=560)
    bt_sair = Button(master2,bd=0,image=img_botao_sair,command= lambda:[sair_aplicativo()])
    bt_sair.place(width= 253, height=100,x=63,y=747)
    bt_valores = Button(master2,bd=0,image=img_botao_valores,command= lambda: [janela_valores()])
    bt_valores.place(width= 253, height=100,x=363,y=206)
    bt_atualizar = Button(master2,bd=0,image=img_botao_atualizar,command= lambda :[atualizar()])
...
# botao entrar
bt_entrar = Button(master,bd=0,image=img_botao,command= lambda:[validar()])
